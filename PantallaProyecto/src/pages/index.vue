...
const colorEstadoHex = (estado) => {
  switch (estado) {
    case 'Poco concurrido': return '#21ba45'    // Verde la baja
    case 'Concurrido': return '#f2c037'   // Amarillo la media
    case 'Muy concurrido': return '#c10015'    // Rojo la ocupacion alta
